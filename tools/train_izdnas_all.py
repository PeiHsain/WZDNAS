...
from lib.core.izdnas_all import train_epoch_dnas, train_epoch_dnas_V2, train_epoch_zdnas, train_epoch_zdnas_all
...
def config_backup(config_bakup_dir, code_backup_dir, args):
    ...
    shutil.copy('lib/core/izdnas_all.py',                  os.path.join(code_backup_dir, 'izdnas_all.py'))
