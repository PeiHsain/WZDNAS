...
from lib.core.zdnas_uw import train_epoch_zdnas_uw
...
def config_backup(config_bakup_dir, code_backup_dir, args):
    ...
    shutil.copy('lib/core/zdnas_uw.py',                     os.path.join(code_backup_dir, 'zdnas_uw.py'))
...
def main():
    ...
    try:
        ...
        for epoch in range(cfg.EPOCHS):
            best_arch = train_epoch_zdnas_uw(epoch, model, wot_function, theta_optimizer, cfg, 
