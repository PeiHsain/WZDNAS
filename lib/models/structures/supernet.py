...
class SuperNet(nn.Module):
    ...
    def calculate_utility_all(self, architecture_info, flops_dict, params_dict, zc_map, lookup_table):
        """
        Params
        ------
        architecutre_info : 
        ...
        return overall_flops, overall_params, overall_zc, overall_latency
